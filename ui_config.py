...
UI_FIELDS = [
    ...
    # Experiment G is implemented but was not in the report — keep it off
    # the interactive UI. Uncomment to restore the terrain sidebar.
...
# env_preset choices stay in the payload; the field itself is hidden from UI_FIELDS.
